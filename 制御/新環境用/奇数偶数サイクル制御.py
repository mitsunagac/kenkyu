...
BASE_OUT       = r"C:\Users\Tsukasa\Desktop\研究\制御\csv掃き出し\奇数偶数サイクル制御"
...
DUAL_MODEL_CONFIG = {
    "1": {
        "model_path":  os.path.join(_PRED_MODEL_DIR, "2. 到着間隔_同時予測", "道路1_1", "GCN_epoch_best_model.pth"),
        "scaler_wait": os.path.join(_PRED_MODEL_DIR, "2. 到着間隔_同時予測", "道路1_1", "scaler_wait.pkl"),
        "scaler_int":  os.path.join(_PRED_MODEL_DIR, "2. 到着間隔_同時予測", "道路1_1", "scaler_interval.pkl"),
    ...
    "5": {
        "model_path":  os.path.join(_PRED_MODEL_DIR, "2. 到着間隔_同時予測", "道路5_1", "GCN_epoch_best_model.pth"),
        "scaler_wait": os.path.join(_PRED_MODEL_DIR, "2. 到着間隔_同時予測", "道路5_1", "scaler_wait.pkl"),
        "scaler_int":  os.path.join(_PRED_MODEL_DIR, "2. 到着間隔_同時予測", "道路5_1", "scaler_interval.pkl"),
...
OFFSET_ADJUST_THRESHOLD  = 15   # 閾値（秒）  例: 20 → ±20s 蓄積で調整開始
